                        ...
                        try {
                            ...
                            while(rs.next()){ %>
                                <div class="container-fluid px-4">
                                    ...
                                    <form action="config/editaProduto.jsp?id=<%=rs.getString("id")%>&imagem=<%=rs.getString("imagem")%>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="<%=rs.getString("endereco")%>" name="endereco" placeholder="Endereço"/> 
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Cidade</label>
                                            <input type="text" class="form-control" value="<%=rs.getString("cidade")%>" name="cidade" placeholder="Cidade"/> 
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Telefone</label>
                                            <input type="text" class="form-control" value="<%=rs.getString("telefone")%>" name="telefone" placeholder="Telefone"/> 
                                        </div>
                                        <div class="mb-3">
